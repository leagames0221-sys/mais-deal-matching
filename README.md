...
[![tests](https://img.shields.io/badge/tests-50%20collected-blue)]()
...
python -m scripts.setup_dev      # outputs VAULT_KEY / SESSION_SECRET
# Copy displayed values into .env (gitignored)
python -m scripts.setup_dev      # 2nd run: encrypts synthetic PII into vault
