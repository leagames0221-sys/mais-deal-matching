"""Stage 1: BM25 sparse lexical retrieval (ADR-005 5-stage pipeline)。
...
Reference: dorianbrown/rank_BM25 (Apache-2.0、 ADR-005 採用)、
...
class BM25Side:
    ...
    ADR-006: operational only 読込。 vault は触らない。
    """
