"""5-stage hybrid matching pipeline (ADR-005、 Stage 1+2+3+4+5)。
...
ADR-006 順守: operational JSONL のみ literal 読込、 vault touched しない。
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="4-stage hybrid matching (ADR-005)")
